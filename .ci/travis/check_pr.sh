...
if [[ $ISSUE_NUMBER =~ ^#[0-9]+$ ]]; then
    LINK_PR=https://api.github.com/repos/MobileApplicationsClub/ARD/pulls/$TRAVIS_PULL_REQUEST
    LINK_ISSUE=https://api.github.com/repos/MobileApplicationsClub/ARD/issues/${ISSUE_NUMBER:1}
    REGEXP=($ISSUE_NUMBER\|https://github.com/MobileApplicationsClub/ARD/issues/${ISSUE_NUMBER:1})
